package br.com.infnet.repositories;

import br.com.infnet.entities.Cliente;
import br.com.infnet.factories.ConnectionFactory;
...
public class ClienteRepository {
	...
	public void create(Cliente cliente) throws Exception {
		...
		PreparedStatement statement = connection.prepareStatement("insert into cliente (nome, email, cpf) values (?, ?, ?)");
